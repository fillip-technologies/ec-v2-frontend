...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="relative isolate overflow-hidden bg-[#FAFBFF] py-16 sm:py-20 lg:py-24">
      <Container size="wide">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          {/* Visual Showcase */}
          <div className="relative">
            <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-tr from-[#6D5DF6]/15 to-[#22C55E]/15 blur-2xl" />
            <div className="relative overflow-hidden rounded-[2.5rem] border border-[#ECEBFF] bg-white p-6 sm:p-8 shadow-2xl">
              <div className="flex items-center justify-between border-b border-[#ECEBFF] pb-4">
                <div className="flex items-center gap-2">
                  <span className="grid h-8 w-8 place-items-center rounded-xl bg-[#F5F3FF] text-[#6D5DF6]">
                    <GraduationCap className="h-4 w-4" />
                  </span>
                  <span className="text-xs font-black uppercase tracking-wider text-[#161326]">
                ...
                {[
                  {
                    ...
                    icon: <Briefcase className="h-4 w-4 text-[#6D5DF6]" />,
                  },
                  {
                  ...
                  <div
                    key={idx}
                    className="flex items-start gap-4 rounded-2xl border border-[#ECEBFF] bg-[#FAFBFF] p-4 transition hover:border-[#6D5DF6] hover:bg-white"
                  >
                    <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-white shadow-sm">
                      {step.icon}
                    </div>
                    <div>
                      <h4 className="text-sm font-black text-[#161326]">{step.title}</h4>
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={idx} className="flex items-start gap-3">
                  ...
                  <span className="text-sm font-bold text-[#161326]">{point}</span>
                </div>
              ))}
            </div>
          </div>
