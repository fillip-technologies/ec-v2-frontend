...
export const DashboardPreviewSection: React.FC = () => {
  return (
    <section className="relative isolate overflow-hidden bg-[#FAFBFF] py-16 sm:py-20 lg:py-24">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-0 h-[32rem] w-[32rem] -translate-x-1/2 rounded-full bg-[#6D5DF6]/10 blur-3xl" />
      ...
      <div className="container-main">
        <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex rounded-full border border-[#ECEBFF] bg-[#F5F3FF] px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-[#6D5DF6]">
            Student Workspace
          </span>
        ...
        <div className="relative mx-auto mt-12 max-w-6xl ec-float">
          <div className="absolute inset-x-10 bottom-0 top-10 rounded-[2rem] bg-[#6D5DF6]/12 blur-3xl" />
          <div className="relative overflow-hidden rounded-[2rem] border border-[#ECEBFF] bg-white/80 p-3 shadow-[0_34px_100px_rgba(15,10,42,0.10)] backdrop-blur-2xl">
            <div className="overflow-hidden rounded-[1.5rem] border border-[#ECEBFF] bg-[#FAFBFF]">
              <img
